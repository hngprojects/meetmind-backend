...
from app.services.candidates_stats import get_candidate_stats
...
async def fetch_candidate_stats(
    ...
    # stats is a validated CandidateStatsData Pydantic model;
    # .model_dump() converts it to a dict for the success envelope.
    return success(
        data=stats.model_dump(), message="Candidate statistics fetched successfully"
    )
